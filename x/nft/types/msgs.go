...
func (msg MsgCreateClass) ValidateBasic() error {
	...
	if msg.FeeBasisPoints > MaxFeeBasisPoints {
		return sdkerrors.Wrapf(ErrInvalidFeeBasisPoints, " got: %d, max: %d", msg.FeeBasisPoints, MaxFeeBasisPoints)
	}
...
func (msg MsgEditClass) ValidateBasic() error {
	...
	if msg.FeeBasisPoints != DoNotModifyFeeBasisPoints && msg.FeeBasisPoints > MaxFeeBasisPoints {
		return sdkerrors.Wrapf(ErrInvalidFeeBasisPoints, " got: %d, max: %d", msg.FeeBasisPoints, MaxFeeBasisPoints)
	}
